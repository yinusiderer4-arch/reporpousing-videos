...
# Usamos el formato 'esm' y la extensión '.mjs' para que Node acepte "import.meta".
RUN npx esbuild src/generate_once.ts --platform=node --format=esm --outfile=generate_once.mjs
